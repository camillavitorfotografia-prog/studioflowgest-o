...
export const DEFAULT_SETTINGS = {
  ...
  integrations: { googleCalendar: 'not_connected', googleDrive: 'not_connected', email: 'not_connected', whatsapp: 'coming_soon', supabase: 'connected', electronicSignature: 'coming_soon', mercadoPago: 'coming_soon', stripe: 'coming_soon', googleMeet: 'coming_soon' },
  templates: [
